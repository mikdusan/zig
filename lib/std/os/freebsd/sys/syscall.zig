...
// to use the syscall.h name unless there is naming conflict,
// in which case any new conflicts will be decorated with a
// version suffix which represents the major os version of
// for which the syscall became available, i.e. `swapoff` and
// `swapoff_k13`.
//
// Such conflicts are rare and since 1.0 it is sufficient to
// use only the major version for naming conflicts.
//
// Note that syscall.h has exactly the opposite approach and
// decorates the existing name and leaves the new syscall
// undecorated, making syscall.h API unstable.
//
...
const sys_tab = .{
    ...
    .{  44, .profil,                     1_000_000 },
    .{  45, .ktrace,                     1_000_000 },
    .{  46, .sigaction,                  1_000_000 },
    .{  47, .getgid,                     1_000_000 },
    .{  48, .sigprocmask,                1_000_000 },
    .{  49, .getlogin,                   1_000_000 },
    .{  50, .setlogin,                   1_000_000 },
    .{  51, .acct,                       1_000_000 },
    .{  52, .sigpending,                 1_000_000 },
    ...
    .{ 103, .sigreturn,                  1_000_000 },
    .{ 104, .bind,                       1_000_000 },
    .{ 105, .setsockopt,                 1_000_000 },
    .{ 106, .listen,                     1_000_000 },
    .{ 111, .sigsuspend,                 1_000_000 },
    ...
    .{ 129, .truncate,                   1_000_000 },
    .{ 130, .ftruncate,                  1_000_000 },
    .{ 131, .flock,                      1_000_000 },
    ...
    .{ 144, .getrlimit,                  1_000_000 },
    .{ 145, .setrlimit,                  1_000_000 },
    .{ 147, .setsid,                     1_000_000 },
    .{ 148, .quotactl,                   1_000_000 },
    .{ 154, .nlm_syscall,                6_004_000 },
    .{ 155, .nfssvc,                     1_000_000 },
    .{ 156, .getdirentries,              1_000_000 },
    .{ 157, .statfs,                     1_000_000 },
    .{ 158, .fstatfs,                    1_000_000 },
    ...
    .{ 173, .pread,                      3_002_000 },
    .{ 174, .pwrite,                     3_002_000 },
    .{ 175, .ntp_gettime,                1_001_005 },
    ...
    .{ 188, .stat_k2,                    2_000_000 },
    .{ 189, .fstat_k2,                   2_000_000 },
    .{ 190, .lstat_k2,                   2_000_000 },
    .{ 191, .pathconf,                   2_000_000 },
    .{ 192, .fpathconf,                  2_000_000 },
    .{ 194, .getrlimit_k2,               2_000_000 },
    .{ 195, .setrlimit_k2,               2_000_000 },
    .{ 196, .getdirentries_k2,           2_000_000 },
    .{ 197, .mmap_k2,                    2_000_000 },
    .{ 198, .__syscall,                  2_000_000 },
    .{ 199, .lseek_k2,                   2_000_000 },
    .{ 200, .truncate_k2,                2_000_000 },
    .{ 201, .ftruncate_k2,               2_000_000 },
    .{ 202, .__sysctl,                   2_000_000 },
    .{ 203, .mlock,                      2_000_000 },
    .{ 204, .munlock,                    2_000_000 },
    .{ 205, .utrace,                     2_002_000 },
    .{ 206, .futimes,                    3_000_000 },
    .{ 207, .getpgid,                    3_000_000 },
    .{ 209, .poll,                       3_000_000 },
    .{ 220, .__semctl,                   2_002_000 },
    .{ 221, .semget,                     2_002_000 },
    .{ 222, .semop,                      2_002_000 },
    .{ 223, .semconfig,                  2_002_000 },
    .{ 224, .msgctl,                     2_002_000 },
    .{ 225, .msgget,                     2_002_000 },
    .{ 226, .msgsnd,                     2_002_000 },
    .{ 227, .msgrcv,                     2_002_000 },
    .{ 228, .shmat,                      2_002_000 },
    .{ 229, .shmctl,                     2_002_000 },
    .{ 230, .shmdt,                      2_002_000 },
    ...
    .{ 248, .ntp_gettime_k6,             6_000_000 },
    .{ 250, .minherit,                   2_002_000 },
    .{ 251, .rfork,                      2_002_000 },
    .{ 252, .openbsd_poll,               3_000_000 },
    .{ 253, .issetugid,                  2_002_005 },
    .{ 254, .lchown,                     2_002_002 },
    .{ 255, .aio_read,                   7_000_000 },
    .{ 256, .aio_write,                  7_000_000 },
    .{ 257, .lio_listio,                 7_000_000 },
    ...
    .{ 297, .fhstatfs,                   4_000_000 },
    .{ 298, .fhopen,                     4_000_000 },
    .{ 299, .fhstat,                     4_000_000 },
    ...
    .{ 318, .aio_read_k3,                3_000_000 },
    .{ 319, .aio_write_k3,               3_000_000 },
    .{ 320, .lio_listio_k3,              3_000_000 },
    .{ 321, .yield,                      3_000_000 },
    ...
    .{ 335, .utrace_k3,                  3_000_000 },
    .{ 336, .sendfile,                   3_001_000 },
    .{ 337, .kldsym,                     3_001_000 },
    .{ 338, .jail,                       4_000_000 },
    .{ 339, .nnpfs_syscall,              8_002_000 },
    .{ 340, .sigprocmask_k4,             4_000_000 },
    .{ 341, .sigsuspend_k4,              4_000_000 },
    .{ 342, .sigaction_k4,               4_000_000 },
    .{ 343, .sigpending_k4,              4_000_000 },
    .{ 344, .sigreturn_k4,               4_000_000 },
    ...
    .{ 393, .sendfile_k4,                4_007_000 },
    .{ 394, .mac_syscall,                5_000_000 },
    .{ 395, .getfsstat_k5,               5_002_000 },
    .{ 396, .statfs_k5,                  5_002_000 },
    .{ 397, .fstatfs_k5,                 5_002_000 },
    .{ 398, .fhstatfs_k5,                5_002_000 },
    ...
    .{ 416, .sigaction_k5,               5_000_000 },
    .{ 417, .sigreturn_k5,               5_000_000 },
    .{ 421, .getcontext,                 5_000_000 },
    .{ 422, .setcontext,                 5_000_000 },
    .{ 423, .swapcontext,                5_000_000 },
    .{ 424, .swapoff,                    5_001_000 },
    ...
    .{ 475, .pread_k7,                   7_000_000 },
    .{ 476, .pwrite_k7,                  7_000_000 },
    .{ 477, .mmap_k7,                    7_000_000 },
    .{ 478, .lseek_k7,                   7_000_000 },
    .{ 479, .truncate_k7,                7_000_000 },
    .{ 480, .ftruncate_k7,               7_000_000 },
    ...
    .{ 510, .__semctl_k7,                7_003_000 },
    .{ 511, .msgctl_k7,                  7_003_000 },
    .{ 512, .shmctl_k7,                  7_003_000 },
    ...
    .{ 551, .fstat_k12,                 12_000_000 },
    .{ 552, .fstatat_k12,               12_000_000 },
    .{ 553, .fhstat_k12,                12_000_000 },
    .{ 554, .getdirentries_k12,         12_000_000 },
    .{ 555, .statfs_k12,                12_000_000 },
    .{ 556, .fstatfs_k12,               12_000_000 },
    .{ 557, .getfsstat_k12,             12_000_000 },
    .{ 558, .fhstatfs_k12,              12_000_000 },
    .{ 559, .mknodat_k12,               12_000_000 },
    .{ 560, .kevent_k12,                12_000_000 },
