...
// version suffix which represents the os version for which the
// syscall was introducted.
//
// Such conflicts are rare and since 1.0 it is sufficient to
// use only the major version for decoration.
//
// Note that syscall.h has exactly the opposite approach and
// decorates the existing name and leaves the new syscall
// undecorated, making the syscall.h API unstable.
//
...
const sys_tab = .{
    ...
    .{ 188, .stat_2,                     2_000_000 },
    .{ 189, .fstat_2,                    2_000_000 },
    .{ 190, .lstat_2,                    2_000_000 },
    .{ 191, .pathconf,                   2_000_000 },
    .{ 192, .fpathconf,                  2_000_000 },
    .{ 194, .getrlimit_2,                2_000_000 },
    .{ 195, .setrlimit_2,                2_000_000 },
    .{ 196, .getdirentries_2,            2_000_000 },
    .{ 197, .mmap_2,                     2_000_000 },
    .{ 198, .__syscall,                  2_000_000 },
    .{ 199, .lseek_2,                    2_000_000 },
    .{ 200, .truncate_2,                 2_000_000 },
    .{ 201, .ftruncate_2,                2_000_000 },
    ...
    .{ 318, .aio_read_3,                 3_000_000 },
    .{ 319, .aio_write_3,                3_000_000 },
    .{ 320, .lio_listio_3,               3_000_000 },
    .{ 321, .yield,                      3_000_000 },
    ...
    .{ 335, .utrace_3,                   3_000_000 },
    .{ 336, .sendfile,                   3_001_000 },
    .{ 337, .kldsym,                     3_001_000 },
    .{ 338, .jail,                       4_000_000 },
    .{ 339, .nnpfs_syscall,              8_002_000 },
    .{ 340, .sigprocmask_4,              4_000_000 },
    .{ 341, .sigsuspend_4,               4_000_000 },
    .{ 342, .sigaction_4,                4_000_000 },
    .{ 343, .sigpending_4,               4_000_000 },
    .{ 344, .sigreturn_4,                4_000_000 },
    ...
    .{ 393, .sendfile_4,                 4_007_000 },
    .{ 394, .mac_syscall,                5_000_000 },
    .{ 395, .getfsstat_5,                5_002_000 },
    .{ 396, .statfs_5,                   5_002_000 },
    .{ 397, .fstatfs_5,                  5_002_000 },
    .{ 398, .fhstatfs_5,                 5_002_000 },
    ...
    .{ 416, .sigaction_5,                5_000_000 },
    .{ 417, .sigreturn_5,                5_000_000 },
    ...
    .{ 475, .pread_7,                    7_000_000 },
    .{ 476, .pwrite_7,                   7_000_000 },
    .{ 477, .mmap_7,                     7_000_000 },
    .{ 478, .lseek_7,                    7_000_000 },
    .{ 479, .truncate_7,                 7_000_000 },
    .{ 480, .ftruncate_7,                7_000_000 },
    ...
    .{ 510, .__semctl_7,                 7_003_000 },
    .{ 511, .msgctl_7,                   7_003_000 },
    .{ 512, .shmctl_7,                   7_003_000 },
    ...
    .{ 551, .fstat_12,                  12_000_000 },
    .{ 552, .fstatat_12,                12_000_000 },
    .{ 553, .fhstat_12,                 12_000_000 },
    .{ 554, .getdirentries_12,          12_000_000 },
    .{ 555, .statfs_12,                 12_000_000 },
    .{ 556, .fstatfs_12,                12_000_000 },
    .{ 557, .getfsstat_12,              12_000_000 },
    .{ 558, .fhstatfs_12,               12_000_000 },
    .{ 559, .mknodat_12,                12_000_000 },
    .{ 560, .kevent_12,                 12_000_000 },
